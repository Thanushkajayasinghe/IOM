        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-3">
                <div class="card border-top-3 border-top-success border-bottom-3 border-bottom-success rounded-0">
                    <div class="card-header" style="padding: 8px;">
                        <h2 class="card-title text-center" style="font-size: 2rem;">SECTION - AU</h2>
                    </div>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-12 form-group">
                                                    <div class="row">
                                                        <div class="col-md-4 form-group">
                                                            <label><span
                                                                    class="fa fa-address-card"></span>&nbsp;&nbsp;AppointmentNo</label>
                                                        ...
                                                        <div class="col-md-4 form-group">
                                                            <label><span
                                                                    class="fa fa-address-card"></span>&nbsp;&nbsp;PassPort
                                                                No</label>
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-4 form-group">
                                                            <label><span
                                                                    class="fa fa-address-card"></span>&nbsp;&nbsp;Age</label>
                                                            <div class="form-group">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-md-3 form-group">
                                                        <input id="hiv_check" class="form-control chkbtt"
                                                            type="checkbox" checked="true">
                                                        <label for="hiv_check" style="font-weight: 700;">HIV
                                                            ELISA</label>
                                                    </div>

                                                    <div class="col-md-2 form-group">
                                                        <input id="malaria_check" class="form-control chkbtt"
                                                            type="checkbox" checked="true">
                                                        <label for="malaria_check"
                                                            style="font-weight: 700;">MALARIA</label>
                                                    </div>
                                                    <div class="col-md-2 form-group">
                                                        <input id="filaria_check" class="form-control chkbtt"
                                                            type="checkbox" checked="true">
                                                        <label for="filaria_check"
                                                            style="font-weight: 700;">FILARIA</label>
                                                    </div>

                                                    <div class="col-md-2 form-group">
                                                        <input id="shcg_check" class="form-control chkbtt"
                                                            type="checkbox">
                                                        <label for="shcg_check" style="font-weight: 700;">S.HCG</label>
                                                    </div>

                                                    <div class="col-md-2 form-group">
                                                        <input id="urine_check" class="form-control chkbtt"
                                                            type="checkbox">
                                                        <label for="urine_check" style="font-weight: 700;">URINE</label>
                                                    </div>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-2">
                                            <button type="button" id="btnCancle"
                                                class="btn-warning btn-yellow btn-lg btn3d btn-block"
                                                style="font-weight: bolder;">
                                                Cancel
                                            </button>
                                        </div>
...
<div class="modal modalBarcode" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Barcode Print</h5>
                <input type="text" id="ageTxtHi" style="display: none;">
                <input type="text" id="genderTxtHi" style="display: none;">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="modalContainerPrintable">
                <svg id="barcodeContainer" style="margin: auto;"></svg>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-warning" id="btnPrintBarcodeCon">Print</button>
...
<script src="{{asset('jsPagesMhac/PhlebotomyAu.js')}}" type="text/javascript"></script>
<script src="{{asset('js/jquery-barcode.min.js')}}" type="text/javascript"></script>
