...
@section('title', 'Make Appointments - Others')
    ...
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Make Appointments - Others</span>
            </div>
        </div>
    </div>
</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <div class="col-md-12 row" style="margin-top: 20px;">
                                                ...
                                                @endphp
                                                <strong>Total Appointmets For {{$segment}}:&nbsp;<lable
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header"
                ...
                <button type="button" class="close" data-dismiss="modal"><img src="{{asset('images/colse.png')}}"
...
<script src="{{asset('jsPagesMhac/MakeAppointmentOt.js')}}" type="text/javascript"></script>
@endsection