...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>CXR Landing</h4>
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">CXR Landing</span>
            </div>
        </div>
    </div>
</div>
...
<script src="{{asset('jsPagesMhac/CXRLanding.js')}}" type="text/javascript"></script>
@endsection
@endif