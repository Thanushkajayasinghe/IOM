...
@section('title', 'Payment Counter  Landing')
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>Payment Counter</h4>
...
<script src="{{asset('jsPagesMhac/PaymentCounterLanding.js')}}" type="text/javascript"></script>
@endsection
@endif