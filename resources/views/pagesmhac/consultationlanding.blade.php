...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>Consultation</h4>
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Consultation</span>
            </div>
        </div>
    </div>
</div>
...
<script src="{{asset('jsPagesMhac/ConsultationLanding.js')}}" type="text/javascript"></script>
@endsection
@endif