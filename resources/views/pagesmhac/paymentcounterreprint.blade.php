...
@section('title', 'Payment Counter Reprint')
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>Payment Counter Reprint </h4>
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Payment Counter Reprint</span>
            </div>
        </div>
    </div>
</div>
...
<script src="{{asset('jsPagesMhac/PaymentCounterReprint.js')}}" type="text/javascript"></script>
@endsection