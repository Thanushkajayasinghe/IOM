...
<html lang="en">
   ...
   <body style="position: relative;text-align: center;background-color: #85FFBD;background-image: linear-gradient(45deg, #85FFBD 0%, #FFFB7D 100%);">
      ...
      <script src="{{asset('jsPagesMhac/CxrDisplay.js')}}?v={{$version}}" type="text/javascript"></script>
      <script>
         var url = "{{url('')}}";   
