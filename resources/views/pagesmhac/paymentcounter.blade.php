...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>Payment Counter
            </h4>
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Payment Counter</span>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="col-md-7">
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input type="text" class="form-control" name="AppointmentNo" id="AppointmentNo"
                                            value="">
                                    </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control dppicker" name="AppointmentDate"
                                                id="AppointmentDate" readonly value="">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <input id="pc_fee" type="text" class="form-control" readonly
                                                disabled="true">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="row form-group">
                                    <div class="col-md-7">
                                        ...
                                        <input id="pc_receipt_no" type="text" class="form-control" readonly
                                            disabled="true">
                                    </div>
                                </div> -->
                            </div>
...
<script src="{{asset('jsPagesMhac/PaymentCounter.js')}}" type="text/javascript"></script>
@endsection
