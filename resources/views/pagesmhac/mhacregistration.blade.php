...
@section('title', ' Mhac Registration')
@section('header')
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-3">
                <div class="card border-top-3 border-top-success border-bottom-3 border-bottom-success rounded-0">
                    <div class="card-header" style="padding: 8px;">
                        @php $segment = request()->segment(count(request()->segments())); @endphp
                        <h2 class="card-title text-center" style="font-size: 2rem;">SECTION - {{ $segment}}</h2>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group" style="border-bottom: 2px solid #d8cdcd;">
                                <div style="font-size: 1.5rem;">
                                    <label>
                                        <span>
                                            <img style="width: 45px;" src="{{asset('images/fingerprint-scanner.png')}}">
...
<script>
    ...
    var usergroupname = ("{{Session::get('GroupName')}}").replace('Registration Counter', '');
