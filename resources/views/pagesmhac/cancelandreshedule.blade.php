...
@section('title', ' Cancel And ReSchedule')
                            ...
                            <div class="card card-body">
                                <div class="row text-center">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <span class="text-muted font-size-sm" style="font-size: 20px;">{{ $segment}}
                                            Appointments</span>
                                    </div>
...
<script src="{{asset('plugins/fullCalender/moment.min.js')}}" type="text/javascript"></script>
    ...
    <script src="{{asset('jsPagesMhac/CancelAndReshedule.js')}}" type="text/javascript"></script>
@endsection