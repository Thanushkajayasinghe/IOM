                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            {{--<div class="col-md-3">--}}
                            {{--<div class="form-group">--}}
                            {{--<button class="btn btn-lg btn-success align-middle legitRipple"--}}
                            {{--style="width: 10rem;" id="next">Next Applicant--}}
                            {{--</button>--}}
                            {{--</div>--}}
                            {{--</div>--}}
                            {{--</div>--}}
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" data-toggle="modal" data-target="#myModal"
                                            ...
                                            <img class="img-thumbnail"
                                                 src="{{url('/images/Lungs1.png')}}"/>
                                        </button>
                                    </div>
                                    <div class="col-md-2 offset-md-2">
                                        <img id="xrayExtender" src="{{url('/images/xray.png')}}" width="200px"
                                             height="200px"
                        ...
                        <div class="col-md-12 form-group text-center">
                            ...
                            {{--<button id="print" class="btn btn-lg btn-primary" style="width: 15rem"><span class="fa fa-print"></span>&nbsp; Print</button>--}}
                        ...
                        <div class="modal-body col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    {{--<div id="editor" style="width:500px; height:500px; border: 1px solid; float: left;background-image:url('{{ asset('/images/Lungs1.png') }}') center center / contain no-repeat; user-select: text;"></div>--}}
                                    <div id="editor"
                                         style="width:100%; height:500px; border: 1px solid; float: left;background: url('{{ asset('/images/Lungs1.png') }}') center center / contain no-repeat;"></div>
...
@section('scripts')
    <script src={{asset('plugins/SketchPad/jqueryOld.js')}} type="text/javascript"></script>
    <script src={{asset('plugins/SketchPad/raphael-2.0.1.js')}} type="text/javascript"></script>
    <script src={{asset('plugins/SketchPad/json2.min.js')}} type="text/javascript"></script>
    <script src={{asset('plugins/SketchPad/raphael.sketchpad.js')}} type="text/javascript"></script>
    <script src={{asset('jsPages/RadiologistReporting.js')}} type="text/javascript"></script>
    <script>
        var urlPath = '{{url('/')}}';
