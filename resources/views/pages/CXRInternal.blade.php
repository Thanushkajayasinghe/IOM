        ...
        <div class="content-wrapper">
            ...
            <div class="row justify-content-center">
                ...
                <span style="display: block;">
                    <img src="{{asset('images/radiology-icon.png')}}" style="width: 53px;"/>
                </span>
                ...
                <div class="col-md-1">
                    <button type="button" class="btn-block btn-brown btn-lg btn3d" id="notyicon02"
                            style="padding: 15px 0 15px;">
                <span style="display: block;">
                    <img src="{{asset('images/list.png')}}" style="width: 53px;"/>
                </span>
                        <span
...
@section('scripts')
    ...
    <script src={{asset('jsPages/OverThePhoneRegistration.js')}} type="text/javascript"></script>
    <script src={{asset('jsPages/CXRInternal.js')}} type="text/javascript"></script>
    <script type="text/javascript">
        ...
        var usergroupname = ("{{Session::get('GroupName')}}").replace('CXR Counter', '');
