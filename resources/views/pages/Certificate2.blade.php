        ...
        <table width="100%">
            <tr width="100%">
                ...
                <td width="55%" style="border: solid 1px black; border-left: 2px solid white;">
                    <label><span
                            style="font-weight:normal;">: {{strtoupper($data->FirstName)}} {{strtoupper($data->LastName)}}</span></label>
                </td>
            </tr>
            <tr width="100%">
            ...
            <tr width="100%">
                ...
                <td width="55%" style="border: solid 1px black;border-left: 2px solid white;">
                    <label><span
                            style="font-weight:normal;">: @if($data->Nationality != null){{ucfirst(trans($data->Nationality))}}@endif</span></label>
                </td>
            </tr>
            <tr width="100%">
                <td width="20%" style="border: solid 1px black;">
                    ...
                    @foreach($sputumDet as $data)
                        @if($data->genexpert == 'Positive')
                            ...
                            <input id="chkbox_007" type="checkbox"
                                   ...
                                   data-fouc="" checked>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        @elseif($data->genexpert == 'Negative')
                            <label for="chkbox_008"><span
                                    class="fa fa-users"></span>Negative</label>
                            <input id="chkbox_008" type="checkbox"
                                   class="form-check-input-styled"
        ...
        <tr width="100%">
            <td width="100%" style="border: 1px solid #0c0c0c;padding: 5px;">
                ...
                @if($cm_dpp_comment != null)
                    <span style="font-weight:normal;">{{$cm_dpp_comment}}</span>
                @else
                    <span style="font-weight:normal;">&nbsp;&nbsp;</span>
                @endif
                <p style="text-align: left;"><b><u>Other Remarks</u></b></p>
                @if($examRemark != null)
                    <span style="font-weight:normal;">{{$examRemark}}</span>
                @else
                    <span style="font-weight:normal;">&nbsp;&nbsp;</span>
                @endif
            </td>
