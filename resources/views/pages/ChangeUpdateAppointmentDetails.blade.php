    ...
    <div class="modal-dialog" style="max-width: 80% !important;">
        <div class="modal-content" style="border-radius: 25px 25px 12px 12px;">
            ...
            <div class="modal-header" style="background-color: #5a8db5; color: white;border-radius: 12px 12px 0 0;padding-bottom: 20px;">
                ...
                <button type="button" class="close" data-dismiss="modal"><img src="{{asset('images/colse.png')}}" width="20px;" height="20px;" />
                </button>
            </div>
                    ...
                    <div class="col-md-12 form-group row">
                        <div class="col-md-4 form-group">
                            <label for="memDOB"><span class="fa fa-hand-o-right"></span>&nbsp;<b>Current
                                    Photo</b></label>
                            <div>
                                <img id="img" src="{{asset('images/user.jpg')}}" width="200px;" height="200px;" />
                            </div>
...
<script src="{{asset('jsPages/ChangeUpdateAppointmentDetails.js')}}" type="text/javascript"></script>
<script>
