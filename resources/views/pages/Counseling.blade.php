                    ...
                    <div class="row">
                        <div class="col-12" style="margin-top: 30px;">
                            ...
                            <div class="card">
                                <div class="row justify-content-center">
                                    <div class="col-md-4">
                                        <a href="{{url('/CounsellingDetails')}}" type="button"
        ...
        <div id="modal2" class="iziModal" data-izimodal-group="group1" data-izimodal-loop=""
            ...
            <div class="card" id="maindiv2">
                <div class="col-md-12 row dataPanelToggle" style="margin-top: 2%;">
                    ...
                    <div class="col-md-3">
                        <img src="{{asset('images/imgcou.png')}}" id="MemberImgTag" class="img-thumbnail"
                             style="width: 80%; height: 200px;  margin-top: 10px;"/>
                        <img src="{{asset('images/Biometric_Authentication.png')}}" class="img-thumbnail"
                             id="biometricAuth"
...
@section('scripts')
    ...
    <script>
        ...
        var usergroupname = ("{{Session::get('GroupName')}}").replace('Counselling Counter', '');
        $('#curCounter').text(usergroupname)
    </script>
    <script src={{asset('jsPages/Counselling.js')}} type="text/javascript"></script>
