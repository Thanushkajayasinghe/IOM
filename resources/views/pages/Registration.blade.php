                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-6 offset-md-3 form-group">
                                                    <img id="biometricAuthenticationImgChange"
                                                         src="{{url('/images/BiometricAuthentication.png')}}"
                                                         style="border: 2px solid black;width: 100%;">
                                                </div>
                                                <div class="col-md-12 text-center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <label><span class="fa fa-address-card"></span>&nbsp;&nbsp;Priority
                                                    ...
                                                    Category</label>
                                                <div class="form-group">
                                                    {{--<input type="text" class="form-control" id="PRC" match="^.+$"--}}
                                    ...
                                    <div style="font-size: 1.5rem;">
                                        ...
                                        <span>
                                            <img style="width: 45px;"
                                                 src="{{asset('images/fingerprint-scanner.png')}}">
...
@section('scripts')
    ...
    <script src="{{asset('jsPages/Registration.js')}}" type="text/javascript"></script>
