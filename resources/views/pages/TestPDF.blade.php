...
<head>
    ...
    <title>IOM | Online Registration </title>
...
{{--<script>--}}
    {{--$('[id="chkbox_001"]').prop('checked', true);--}}
{{--</script>--}}
{{--<body>--}}
<table style="width: 100%;">
    <thead>
      <tr style="width: 100%;">
          ...
          <td style="width: 20%;"> <label>{{  $ApplicantDetails->PassportNumber}}</label></td>
          <td style="width: 10%;">Name</td>


          <td style="width: 45%;" colspan="3"> <label id="name">{{  $ApplicantDetails->FirstName}} {{$ApplicantDetails->LastName}}</label></td>

      </tr>
      <tr style="width: 100%;">
          <td style="width: 15%;">Registration No</td>
          <td style="width: 20%;"><label>{{  $ApplicantDetails->AppointmentNumber}}</label></td>
          <td style="width: 10%;">Date Of Birth</td>
          <td style="width: 15%;"><label>{{  $ApplicantDetails->DateOfBirth}}</label></td>
          <td style="width: 10%;">Gender</td>
          <td style="width: 20%;"><label>{{  $ApplicantDetails->Gender}}</label></td>
    ...
    <div class="row" style="margin-top: 30px;">
            ...
            <table style="width: 100%;">
                <tr>
                    <td style="width: 5%;">
                        ...
                        @if($ApplicantDetails->rr_single_fibrous_streak==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_bony_islets==1)
                ...
                <tr>
                    <td style="width: 5%;">
                        @if($ApplicantDetails->rr_pleural_capping==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_unilateral_bilateral==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_calcified_nodule==1)
        ...
        <div class="col-md-4" style="margin-top: 10px;">
            ...
            <table style="width: 100%;">
                <tr>
                    <td style="width: 5%;">
                        @if($ApplicantDetails->rr_solitary_granuloma_hilum==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_solitary_granuloma_enlarged==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_single_multi_calc_pulmonary==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_calcified_pleural_lesions==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_costophrenic_angle==1)
        ...
        <div class="col-md-4" style="margin-top: 10px;">
            ...
            <table style="width: 100%;">
                <tr>
                    <td style="width: 5%;">
                        @if($ApplicantDetails->rr_notable_apical==1)
                    ...
                    <td style="width: 95%;">
                        4.0 Notable apical pleural capping(rough or rangged inferior borderand/or_>1cm thick at any point)
                    </td>
                </tr>
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_aplcal_fbronodualar==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_multi_single_pulmonary_nodu_micronodules==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_isolated_hilar==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_multi_single_pulmonary_nodu_masses==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_non_calcified_pleural_fibrosos==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_interstltial_fbrosos==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_any_cavitating_lesion==1)
        ...
        <div class="col-md-4" style="margin-top: 10px;">
            ...
            <table style="width: 100%;">
                <tr>
                    <td style="width: 5%;">
                        @if($ApplicantDetails->rr_skeleton_soft_issue==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_cardiac_major_vessels==1)
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_lung_fields==1)
      ...
      lung fields
                ...
                <tr>
                    <td>
                        @if($ApplicantDetails->rr_other==1)
        ...
        {{--====================================================================================================--}}
        <div class="col-md-4" style="margin-top: 10px;">
            Comment01:<lable>{{ $ApplicantDetails->rr_comment1 }}</lable>
        </div>
        {{--====================================================================================================--}}
        <div class="col-md-4" style="margin-top: 10px;">
            Comment02:<lable>{{ $ApplicantDetails->rr_comment2 }}</lable>
        </div>
        <div class="col-md-12" style="margin-top: 10px;">
            <table style="width: 100%;">
                ...
                <tr style="margin-top: 20px;">
                    ...
                    <td style="width: 30%;">
                        <img id="IMGsignature" src="{{ $bcode }}" style="height: 60px; width: 150px;padding: 0;"/>
                    </td>
                </tr>
                <tr style="margin-top: 20px;">
                    <td style="width: 70%;">
                ...
                <tr style="margin-top: 20px;">
                    ...
                    <td style="width: 30%;">
                        {{ $cby= Session::get('firstName')." ".$cby= Session::get('lastName') }}
                    </td>
                </tr>
            </table>
        </div>
