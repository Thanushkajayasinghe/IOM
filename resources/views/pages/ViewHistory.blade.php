                                        ...
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="col-md-12 form-group">
                                                        <div class="col-md-12 form-group">
                                                            <img id="img" class="img-thumbnail" src="{{url('images/PhotoBooth.png')}}" style="border: 2px solid black; height: 210px; width: 100%;">
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="checkbox-parent" class="col-md-12 form-group">
                                            <div class="row form-group">
                                                <div class="col-md-2">
                                                    <div class="col-md-12 form-group">
                                                        <img class="img-thumbnail" style="width: 200px; height: 200px;" src={{asset('images/Lungs.png')}}>
                                                    </div>
                                                    <div class="col-md-12 form-group">
                                                        <img class="img-thumbnail" style="width: 200px; height: 200px;" src={{asset('images/xray.png')}}>
                                                    </div>
                                                </div>
                                                <div class="col-md-10">
...
<script src={{asset('jsPages/ViewHistory.js')}} type="text/javascript"></script>
