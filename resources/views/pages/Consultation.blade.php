                    ...
                    <div class="content" style="padding: 1.25rem 0;">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-md-12 form-group">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-3">
                                            <button
                                                class="btn btn-lg btn-warning btnPrintSystemLabRequest"
                                                style="width: 15rem;">
                                                Print
                                            </button>
                                        </div>
                                                                          ...
                                                                          name="remarkAFC"></textarea>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            @if($readOnly != 'true')
                                                                                                ...
                                                                                                <button
                                                                                                    class="btn btn-lg btn-warning btnPrintRefLetter"
                                                                                                    style="width: 15rem;">
                                                                                                    Print
                                                                                                </button>
                                                                                            @endif
                                                                              ...
                                                                              name="remarkTB"></textarea>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            @if($readOnly != 'true')
                                                                                                ...
                                                                                                <button
                                                                                                    class="btn btn-lg btn-warning btnPrintRefLetterTb"
                                                                                                    style="width: 15rem;">
                                                                                                    Print
                                                                                                </button>
                                                                                            @endif
                                                                                    ...
                                                                                    <div id="validateDivOther">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            @if($readOnly != 'true')
                                                                                                ...
                                                                                                <button
                                                                                                    class="btn btn-lg btn-warning btnPrintOtherRefLetter"
                                                                                                    style="width: 15rem;">
                                                                                                    Print
                                                                                                </button>
                                                                                            @endif
                            ...
                            <div class="col-md-12 form-group text-center">
                                ...
                                <a href='javascript:void(0);' class="btn-lg btn-success btn3d" id="Tempsave" style="display: none;">Temporary
                                    Save</a>
...
@section('scripts')
    ...
    <script>
        var urlPath = '{{url('/')}}';
        var imgPath = '{{url('/tempFileUpload/photoBoothFiles')}}';
        var imgPathBlade = '{{url('images/')}}';
        var fingerPrintPath = '{{url('/tempFileUpload/')}}';
        const usergroup = "{{Session::get('userGroup')}}";
        var usergroupname = ("{{Session::get('GroupName')}}").replace('Consultation Counter', '');
        $('#curCounter').text(usergroupname)
    </script>
    <script src={{asset('jsPages/Consultation.js')}} type="text/javascript"></script>
    <script>
        $('#noshow').iziModal({
            headerColor: '#26A69A',
            width: '90%',
    ...
    <script src="{{asset('jsPages/RefferToAll.js')}}" type="text/javascript"></script>
    <script>
        function checkValio() {
