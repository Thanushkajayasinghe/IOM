...
@section('title', 'Phlebotomy Sample Collection')
                        ...
                        <div class="card">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-3">
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <img src="{{asset('images/Biometric_Authentication.png')}}"
                                                         class="img-thumbnail"
                                                         id="biometricAuth"
                            ...
                            <div class="card-body">
                                <center>
                                    ...
                                    {{--<button type="button" id="PrintBC"--}}
                                    {{--class="btn-info btn-lg btn3d"--}}
                                    {{--style="width: 15rem; position: relative;left: 7px; font-weight: bold; display: none;">--}}
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var fingerPrintPath = '{{url('/tempFileUpload/')}}';
        const usergroup = "{{Session::get('userGroup')}}";
        var usergroupname = ("{{Session::get('GroupName')}}").replace('Phlebotomy Counter', '');
        $('#curCounter').text(usergroupname)
    </script>
    <script src={{asset('jsPages/PhlebotomySampleCollection.js')}} type="text/javascript"></script>
    <script>
        $('#noshow').iziModal({
            headerColor: '#26A69A',
            width: '90%',
