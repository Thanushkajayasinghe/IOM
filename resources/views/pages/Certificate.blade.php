        ...
        <table style="width: 100%; margin-top: 25px;">
            <tr>
                <td width="25%" rowspan="6" style="border: solid 1px black ; ">
                    ...
                    @else
                    <img src="{{ asset('/tempFileUpload/photoBoothFiles/'. $photo) }}" style="height: 150px; width: 170px; position: relative; border: 2px solid black;">
                    @endif
                </td>
                ...
                <td width="55%" style="border: solid 1px black; border-left: 2px solid white;">
                    <label><span style="font-weight:normal;">: {{strtoupper($data->FirstName)}} {{strtoupper($data->LastName)}}</span></label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="55%" style="border: solid 1px black;border-left: 2px solid white;">
                    <label><span style="font-weight:normal;">: {{$data->DateOfBirth}}</span></label>
                </td>
            </tr>
            <tr>
                <td width="20%" style="border: solid 1px black;">
                ...
                <td width="55%" style="border: solid 1px black;border-left: 2px solid white;">
                    <label><span style="font-weight:normal;">: {{$data->PassportNumber}}</span></label>
                </td>
            </tr>
            <tr>
                <td width="20%" style="border: solid 1px black;">
                ...
                <td width="55%" style="border: solid 1px black;border-left: 2px solid white;">
                    <label><span style="font-weight:normal;">: @if($data->Nationality != null){{ucfirst(trans($data->Nationality))}} @endif</span></label>
                </td>
            </tr>
            <tr>
                <td width="20%" style="border: solid 1px black;">
                ...
                <td width="55%" style="border: solid 1px black;border-left: 2px solid white;">
                    <label><span style="font-weight:normal;">: {{$data->AppointmentDate}}</span></label>
                </td>
            </tr>
        </table>
        @endforeach
                ...
                <td style="width: 50%; float: right; border: 1px solid black;">
                    <table style="width: 90%; margin-top: 6px; margin-bottom: 10px;" align="center">
                        ...
                        <tr>
                            ...
                            @if($examRemark[0]->cm_order_sputum_sample)
                            <td style="width: 30%">
                        ...
                        <tr>
                            ...
                            <td style="width: 30%">
                                <label for="chkbox_001"><span class="fa fa-users"></span>Done</label>
                                <input id="chkbox_001" type="checkbox" class="form-check-input-styled" data-fouc="" @if($examRemark[0]->cm_order_sputum_sample == 1)
                                checked
                                @endif>
                            </td>
                            <td style="width: 30%">
                                <label for="chkbox_002"><span class="fa fa-users"></span>&nbsp;&nbsp;&nbsp;&nbsp;Not Done</label>
                                <input id="chkbox_002" type="checkbox" class="form-check-input-styled" data-fouc="" @if($examRemark[0]->cm_order_sputum_sample != 1)
                                checked
                                @endif>
                            </td>
                        </tr>
                ...
                <td style="width: 49%; float: left; border: 1px solid black;">
                    <table style="width: 90%; margin-top: 6px; margin-bottom: 10px;" align="center">
                        ...
                        <tr>
                            ...
                            <td style="width: 30%">
                                <label for="chkbox_001"><span class="fa fa-users"></span>Done </label>
                                <input id="chkbox_001" type="checkbox" class="form-check-input-styled" data-fouc="" @if($cxrDet[0]->cxr_done == true)
                                checked
                                @endif>
                            </td>
                            <td style="width: 30%">
                                <label for="chkbox_002"><span class="fa fa-users"></span>&nbsp;&nbsp;&nbsp;&nbsp;Not Done</label>
                                <input id="chkbox_002" type="checkbox" class="form-check-input-styled" data-fouc="" @if($cxrDet[0]->cxr_not_done == true)
                                checked
                                @endif>
                            </td>
                        </tr>
                ...
                <td style="width: 50%; float: right; border: 1px solid black;">
                    <table style="width: 90%; margin-top: 6px; margin-bottom: 10px;" align="center">
                        ...
                        <tr>
                            <td style="width: 40%"></td>
                            @if($HIVres->count() > 0)
                            @if( $HIVres[0]->prtr_result == "Positive" || $Malres[0]->prtr_result == "Positive" || $FilRes[0]->prtr_result == "Positive")
                            <td style="width: 30%">
                                <label for="chkbox_001"><span class="fa fa-users"></span>Done</label>
                                <input id="chkbox_001" type="checkbox" class="form-check-input-styled" data-fouc="" checked>
                            </td>
                            ...
                            @endif
                            @else
                            @if($Malres[0]->prtr_result == "Positive" || $FilRes[0]->prtr_result == "Positive")
                            <td style="width: 30%">
                                <label for="chkbox_001"><span class="fa fa-users"></span>Done</label>
                                <input id="chkbox_001" type="checkbox" class="form-check-input-styled" data-fouc="" checked>
                            </td>
