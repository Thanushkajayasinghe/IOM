...
@section('title', 'IOM - Sample Collections')
            ...
            <div class="content">
                <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <div class="col-md-12">
                                            <img style="border: 2px solid black;width: 200px;"
                                                 src={{asset('images/Fingerprint.jpg')}} >
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 form-group text-center">
                        ...
                        {{--<a id="printbtn"><button class="btn btn-success btn-lg"><span class="fa fa-print"></span>&nbsp;&nbsp;PRINT</button></a>--}}
                    </div>
...
@section('scripts')
    <script src={{asset('jsPages/SampleCollection.js')}} type="text/javascript"></script>
