...
@section('title', 'IHU - RECOMMENDATION')
                                                            ...
                                                            <div class="col-md-12">
                                                                <div id="">
                                                                    <div class="col">
                                                                        ...
                                                                        {{--<div class="col-md-12 row">--}}
                                                                        {{--<div class="col-md-2">--}}
                                                                        {{--<label><span class="fa fa-hand-o-right"></span>&nbsp;&nbsp;Institute</label>--}}
                                                                        {{--</div>--}}
                                                                        {{--<div class="col-md-6">--}}
                                                                ...
                                                                <div id="validateDivM">
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="col">
                                                                            ...
                                                                            {{--<div class="col-md-2">--}}
                                                                            {{--<label><span--}}
                                                                            {{--class="fa fa-hand-o-right"></span>&nbsp;&nbsp;Institute</label>--}}
                                                                            {{--</div>--}}
                                                                            {{--<div class="col-md-6">--}}
                                                                            {{--<input type="text" class="form-control"--}}
                                                                            {{--id="DOCinstitute"/>--}}
                                                                            ...
                                                                            <div class="row form-group">
                                                                                <div class="col-md-12 row">
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                    <textarea class="form-control" rows="5" id="DOCcomment"></textarea>
                                                                                            </div>
                                                                                            <div
                                                                                        class="text-danger error"></div>
                                                                                </div>
