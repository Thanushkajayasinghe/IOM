                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-bordered table-hover table-striped text-center"
                                            ...
                                            <tr>
                                                ...
                                                <th nowrap>Radiology</th>
                                                <th nowrap>Radiology Counter</th>
...
@section('scripts')
    ...
    <script src="{{asset('js/jquery.jstepper.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('jsPages/ChangeStatus.js')}}" type="text/javascript"></script>
@endsection
