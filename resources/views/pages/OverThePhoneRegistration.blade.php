...
@section('title', 'Over The Phone Registration')

@if($readWrite == 'true')

@section('header')
<link href="{{asset('css/3dbuttons.css')}}" rel="stylesheet" type="text/css">
<link href="{{asset('plugins/fullCalender/fullcalendar.min.css')}}" rel="stylesheet" type="text/css" />
...
<script src="{{asset('plugins/fullCalender/fullcalendar.min.js')}}" type="text/javascript"></script>
...
<script>
    ...
    var imgPathBlade = "{{url('/images/numbers/')}}";
