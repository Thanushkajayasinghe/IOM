                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card" style="padding-left: 20px; padding-top: 20px;">
                            ...
                            <div class="col-md-12 row" style="margin-top: 10px;">
                                ...
                                {{--<div class="col-md-5">--}}
                                    {{--<lable><span class="fa fa-hand-o-right"></span>&nbsp;&nbsp;Signature</lable>--}}
                            ...
                            <div class="col-md-12 row justify-content-center" style="margin-top: 10px;">
                                {{--<div class="col-md-3 form-group">--}}
                                    {{--<button id="completeCoun" type="button" class="btn-block btn-success btn-lg btn3d">--}}
                                        {{--<sapn class="fa fa-check">&nbsp;&nbsp;&nbsp;</sapn>--}}
                                        {{--Counseling Completed--}}
                                    {{--</button>--}}
                                {{--</div>--}}
                                {{--<div class="col-md-3 form-group">--}}
                                    {{--<button id="notcompleteCoun" type="button"--}}
                                            {{--class="btn-block btn-danger btn-lg btn3d">--}}
...
@section('scripts')
    <script>
        ...
        var pathAudio = '{{url('/tempFileUpload/')}}';
        const usergroup = "{{Session::get('userGroup')}}";
    </script>
    <script src={{asset('jsPages/CounsellingDetails.js')}} type="text/javascript"></script>
