...
Main Applicant passport no : <b style="color: #ff0a14;">{{ $mainPassNo }}</b> , <br><br>

Applicant Date : <b style="color: #1b4b72;">{{ $appDate }}</b> , <br><br>

Applicant Time : <b style="color: #1b4b72;">{{ $appTime }}</b> . <br><br><br>
...
<table width="100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center"><img src="data:image/svg+xml;base64,{{ $row['barcode'] }}"
