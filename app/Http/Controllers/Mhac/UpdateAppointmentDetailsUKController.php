...
class UpdateAppointmentDetailsUKController extends Controller
{
    public function ViewPage()
    {
        ...
        return view('pagesmhac.changeupdateappointmentdetailsuk')->with(['readOnly' => $readOnly, 'readWrite' => $readWrite]);
    }
