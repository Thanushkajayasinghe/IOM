...
class UpdateAppointmentDetailsOTController extends Controller
{
    public function ViewPage()
    {
        ...
        return view('pagesmhac.changeupdateappointmentdetailsot')->with(['readOnly' => $readOnly, 'readWrite' => $readWrite]);
    }
