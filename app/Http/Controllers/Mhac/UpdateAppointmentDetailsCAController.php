...
class UpdateAppointmentDetailsCAController extends Controller
{
    public function ViewPage()
    {
        ...
        return view('pagesmhac.changeupdateappointmentdetailsca')->with(['readOnly' => $readOnly, 'readWrite' => $readWrite]);
    }
