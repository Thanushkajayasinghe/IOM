...
class UpdateAppointmentDetailsNZController extends Controller
{
    public function ViewPage()
    {
        ...
        return view('pagesmhac.changeupdateappointmentdetailsnz')->with(['readOnly' => $readOnly, 'readWrite' => $readWrite]);
    }
