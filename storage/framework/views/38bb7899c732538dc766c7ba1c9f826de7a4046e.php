<?php $__env->startSection('title', ' Mhac Registration'); ?>
...
<style>
    ...
    .main-member-row {
        ...
        /* Set the text color to red with !important */
        /* Add any other styles you want for the MainMember row */
    }
</style>
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>Registration
            </h4>
...
<div class="page-content pt-0">
    ...
    <div class="content-wrapper" style="padding: 0 5px;">
            ...
            <div class="col-sm-3">
                <div class="card border-top-3 border-top-success border-bottom-3 border-bottom-success rounded-0">
                    <div class="card-header" style="padding: 8px;">
                        ...
                        <h2 class="card-title text-center" style="font-size: 2rem;">SECTION - <?php echo e($segment); ?></h2>
                    </div>
        ...
        <!-- Content area -->
        <div class="row justify-content-center" id="maindiveid">
                                ...
                                <div class="row justify-content-center" style="font-size: 1rem;text-align: center;">
                                            ...
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="background-color: #f98469; display:none">Member </th>
                                                    </tr>
                                                </thead>
                                                <tbody id="appbody">
                                    ...
                                    <div class="col-md-3">
                                        <button type="button" class="btn-block btn-grr btn-lg btn3d"
                                            id="btnUpdateDetails" style="padding: 6%;font-size: 1.2rem;color: #322a2a;">
                            ...
                            <div class="showHideDiv" style="display:none;">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label><span class="fa fa-address-card"></span>&nbsp;&nbsp;Appointment
                                                No</label>
                                            <div class="form-group">
                                                <input type="text" class="form-control" disabled="" id="AppointmentNo">
                                            </div>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label><span class="fa fa-address-card"></span>&nbsp;&nbsp;Passport
                                                No</label>
                                            <div class="form-group">
                                                <input type="text" class="form-control" disabled="disabled" match="^.+$"
                                                    validate="true" error="* required" id="PassportNo">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" class="form-control dppicker" disabled="disabled"
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-12 text-center">
                                                <button id="takephotobtn" class="btn3d btn-magickred"
                                ...
                                <div class="col-md-12 form-group">
                                    <div class="row justify-content-center">
                                        <div class="col-md-9 form-group">
                                            <label>
                                                <span class="fa fa-address-card"></span>&nbsp;&nbsp;Remarks
                                            </label>
                                            <div class="form-group">
                                ...
                                <br><br>
                                <div id="ptomodal" data-izimodal-group="group1c" data-izimodal-loop=""
                                    data-izimodal-title="Photo Booth" data-izimodal-subtitle="Photo Booth"
                                    style="display:none">
                                    <div class="card">
                                        <div class="card-body">

                                            <div class="col-md-12 form-group">
                                            <div class="row" id="modphoto">
                                                <!-- <div class="row">
                                                        ...
                                                        <div class="row justify-content-center">
                                                            <div class='col-md-10'
                                                                ...
                                                                <div style="position: relative;">
                                                                    <video controls autoplay
                                                                        style="width: 440px; height: 330px;"></video>
                                                            ...
                                                            <div class='col-md-12'>
                                                                <div class='col-md-4 offset-md-4'>
                                                                    <button type="button"
                                                                        class="btn-block btn-success btn-lg btn3d"
                                                                        id="capturePhoto">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="row justify-content-center">
                                                            <div class='col-md-10'
                                                                style="margin: 20px;padding: 20px;border: 4px solid #8c5136;background: #f5f5f5; text-align: center;">
                                                                <canvas id="captureImage"
                                                                    style="width: 440px; height: 330px;"></canvas>
        ...
        <div id="biomodal" data-izimodal-group="group1x" data-izimodal-loop="" data-izimodal-title="Biometrics Details"
            data-izimodal-subtitle="Biometrics" style="display:none">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group" style="border-bottom: 2px solid #d8cdcd;">
                                <div style="font-size: 1.5rem;">
                                    <label>
                                        <span>
                                            <img style="width: 45px;" src="<?php echo e(asset('images/fingerprint-scanner.png')); ?>">
                            ...
                            <div class="col-md-12 form-group">
                                <div class="row align-items-center" style="text-align: center;">
                                    <div class="col-md-12">
                                        <button type="button" id="saveBiometricData" class="btn-lg btn3d btn-graygreen"
                                            style="width: 15rem;"><span class="fa fa-floppy-o"></span>&nbsp;&nbsp;Save
                                        </button>
                                    </div>
                                </div>
                            </div>
...
<script src="<?php echo e(asset('jsPagesMhac/MhacRegistration.js')); ?>" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    transitionOut: 'fadeOutDown',
    onOpening: function (modal) {
        // Dynamically create and append the HTML content to the modal
        var modalContent = '<div class="col-md-12 form-group">' +
            '<div class="row">' +
                '<div class="col-md-6">' +
                ...
                '<div class="col-md-6">' +
                    ...
                    '<div class="row justify-content-center">' +
                        '<div class="col-md-10" style="margin: 20px;padding: 20px;border: 4px solid #8c5136;background: #f5f5f5; text-align: center;">' +
                            ...
                            '<img id="showEditedImage" style="width: 440px; height: 330px; display: none" />' +
                        '</div>' +
                        '<div class="col-md-12">' +
                            '<div class="row justify-content-center">' +
                                '<div class="col-md-12 text-center">' +
                                    '<button type="button" id="editPhoto" class="btn-primary btn-lg btn3d" style="padding-left: 24px; padding-right: 24px;">' +
                                        '<i class="fa fa-pencil"></i>' +
                                        '<span>Edit</span>' +
                                    '</button>' +
                                    '<button type="button" id="savePhoto" class="btn-success btn-lg btn3d" style="padding-left: 20px; padding-right: 20px;">' +
                                        '<i class="fa fa-floppy-o"></i>' +
                                        '<span>Save</span>' +
                                    '</button>' +
                                    '<button type="button" id="cancelPhoto" class="btn-danger btn-lg btn3d" style="padding-left: 15px; padding-right: 15px;">' +
        ...
        // Set the content of the modal using iziModal's setContent method
        $("#modphoto").html("").html( modalContent);

        // Call your functions here (e.g., loadWebCamera(), face detection setup)
        loadWebCamera();

        setTimeout(function () {
            // Your face detection setup code here
            var videoTag = document.getElementsByTagName("video")[0];
            var canvas = document.querySelector("#detectFace");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/mhacregistration.blade.php ENDPATH**/ ?>