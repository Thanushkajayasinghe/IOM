<?php $__env->startSection('title', 'Cancel No Show Applicants'); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <!--JS files-->
    <script src="<?php echo e(asset('jsPages/CancelApplicants.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\iom\resources\views/pages/CancelApplicants.blade.php ENDPATH**/ ?>