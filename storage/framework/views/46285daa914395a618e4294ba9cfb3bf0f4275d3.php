                            ...
                            <div id="tableContainer" class="table-responsive">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped text-center dataTable"
                                        ...
                                        <thead style="background: linear-gradient(40deg,#45cafc,#303f9f) !important; color: white;">
                                        <tr>
                                            <th nowrap></th>
                                            <th nowrap>Date</th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <!--JS files-->
    <script src="<?php echo e(asset('jsPages/PaymentHistory.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>




<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pages/PaymentHistory.blade.php ENDPATH**/ ?>