...
<html lang="en">
   ...
   <body style="position: relative;text-align: center; background: linear-gradient(to right, #159957, #bfdfff);">
                     ...
                     <div class="col-12 row" style="border-bottom: 2px solid #bcb9b9;">
                        <div class="col-md-6">
                           <h1 style="font-size: 3rem;"><span class="badge badge-primary"
                              style="padding: 14px;border-radius: 35px;background: #034981;">CXR CENTER</span>
                           </h1>
                        </div>
      ...
      <script src="<?php echo e(asset('jsPagesMhac/CxrDisplay.js')); ?>?v=<?php echo e($version); ?>" type="text/javascript"></script>
      <script>
...
</html><?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/cxrdisplay.blade.php ENDPATH**/ ?>