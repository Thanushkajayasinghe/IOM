<?php $__env->startSection('title', 'Make Appointments'); ?>
    ...
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Make Appointments</span>
            </div>
        </div>
    </div>
</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <div class="col-md-12 row" style="margin-top: 20px;">
                                                <strong>Total Appointmets For <span id="txtCountryPlaceHolder"></span>:&nbsp;<lable id="totalAppointmentCount"></lable></strong>
                                            </div>
...
<script src="<?php echo e(asset('jsPagesMhac/MakeAppointment.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/makeappointment.blade.php ENDPATH**/ ?>