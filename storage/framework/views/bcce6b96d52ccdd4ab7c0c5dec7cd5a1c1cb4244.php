<?php $__env->startSection('title', 'Vitals'); ?>
                ...
                <div class="col-sm-3">
                    <div class="card border-top-3 border-top-success border-bottom-3 border-bottom-success rounded-0">
                        ...
                        <div class="card-body" style="padding: 12px;">
                            <h2 class="card-title text-center" style="font-size: 2rem; color: green;">Vitals</h2>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
...
<script>
        ...
        const country = "AU";
        var usergroupname = ("<?php echo e(Session::get('GroupName')); ?>");
    ...
    <script src="<?php echo e(asset('jsPagesMhac/Vitals.js')); ?>" type="text/javascript"></script>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/vitalsau.blade.php ENDPATH**/ ?>