...
<head>
    ...
    <title>IOM | Phlebotomy Main Display</title>
...
<body style="background: linear-gradient(to right, #4691cf4d, #e5f1f5, #309f907d);">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h1 style="font-size: 4rem;"><span class="badge badge-primary"
                                                           style="padding: 14px; border-radius: 35px;">SAMPLE COLLECTION CENTER</span>
                        </h1>
                    </div>
    ...
    <script src="<?php echo e(asset('jsPages/SampleCollectionMainDisplay.js')); ?>" type="text/javascript"></script>
</body>
</html>
<?php /**PATH C:\wamp64\www\IOM\resources\views/pages/SampleCollectionMainDisplay.blade.php ENDPATH**/ ?>