        ...
        <table width="100%">
            <tr style="width: 100%; text-align: center; ">
                <td style="text-align: center;">
                    <img src="<?php echo e(asset('images/logonew2.jpg')); ?>" style="height: 80px;display: inline-block;position: relative;">
                </td>
            </tr>
        </table>
        ...
        <table style="width: 100%; margin-top: 25px;">
            <tr>
                <td width="25%" rowspan="6" style="border: solid 1px black ; ">
                    ...
                    <img src="<?php echo e(asset('images/blank-user.jpg')); ?>" style="height: 140px; position: relative; border: 2px solid black;">
                    <?php else: ?>
                    <img src="<?php echo e(asset('/tempFileUpload/photoBoothFiles/'. $photo)); ?>" style="height: 150px; width: 170px; position: relative; border: 2px solid black;">
                    <?php endif; ?>
                </td>
                ...
                <td width="55%" style="border: solid 1px black; border-left: 2px solid white;">
                    <label><span style="font-weight:normal;">: <?php echo e(strtoupper($data->FirstName)); ?> <?php echo e(strtoupper($data->LastName)); ?></span></label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="55%" style="border: solid 1px black;border-left: 2px solid white;">
                    <label><span style="font-weight:normal;">: <?php if($data->Nationality != null): ?><?php echo e(ucfirst(trans($data->Nationality))); ?> <?php endif; ?></span></label>
                </td>
            </tr>
            <tr>
                <td width="20%" style="border: solid 1px black;">
                ...
                <td width="55%" style="border: solid 1px black;border-left: 2px solid white;">
                    <label><span style="font-weight:normal;">: <?php echo e($data->AppointmentDate); ?></span></label>
                </td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <td style="width: 50%; float: right; border: 1px solid black;">
                    <table style="width: 90%; margin-top: 6px; margin-bottom: 10px;" align="center">
                        <tr>
                            <td colspan="3">
                                <p style="text-align: left; font-size: 15px;"><b><u>Sputum Spot Test (Gene
                                            Xpert)</u></b></p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 30%">
                                <label><span class="fa fa-users"></span>Done</label>
                                <input type="checkbox" class="form-check-input-styled" data-fouc="" checked>
                            </td>
                            <td style="width: 30%">
                                <label><span class="fa fa-users"></span>Not Done</label>
                        ...
                        <tr style="visibility: hidden;">
                            <td colspan="3">
                                <p style="text-align: left; font-size: 15px;"><b><u>for space</u></b>
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 30%">
                                <label for="chkbox_001"><span class="fa fa-users"></span>Done</label>
                                <input id="chkbox_001" type="checkbox" class="form-check-input-styled" data-fouc="" <?php if($examRemark[0]->cm_order_sputum_sample == 1): ?>
                                checked
                                <?php endif; ?>>
                            </td>
                            <td style="width: 30%">
                                <label for="chkbox_002"><span class="fa fa-users"></span>&nbsp;&nbsp;&nbsp;&nbsp;Not Done</label>
                                <input id="chkbox_002" type="checkbox" class="form-check-input-styled" data-fouc="" <?php if($examRemark[0]->cm_order_sputum_sample != 1): ?>
                                checked
                                <?php endif; ?>>
                            </td>
                        </tr>
            ...
            <tr>
                <td style="width: 49%; float: left; border: 1px solid black;">
                    <table style="width: 90%; margin-top: 6px; margin-bottom: 10px;" align="center">
                        <tr>
                            <td colspan="3">
                                <p style="text-align: left; font-size: 15px;"><b><u>Radiology Test</u></b>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 30%">
                                <label for="chkbox_001"><span class="fa fa-users"></span>Done </label>
                                <input id="chkbox_001" type="checkbox" class="form-check-input-styled" data-fouc="" <?php if($cxrDet[0]->cxr_done == true): ?>
                                checked
                                <?php endif; ?>>
                            </td>
                            <td style="width: 30%">
                                <label for="chkbox_002"><span class="fa fa-users"></span>&nbsp;&nbsp;&nbsp;&nbsp;Not Done</label>
                                <input id="chkbox_002" type="checkbox" class="form-check-input-styled" data-fouc="" <?php if($cxrDet[0]->cxr_not_done == true): ?>
                                checked
                                <?php endif; ?>>
                            </td>
                        </tr>
                ...
                <td style="width: 50%; float: right; border: 1px solid black;">
                    <table style="width: 90%; margin-top: 6px; margin-bottom: 10px;" align="center">
                        <tr>
                            <td colspan="3">
                                <p style="text-align: left; font-size: 15px;"><b><u>Referrals</u></b></p>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 40%"></td>
                            ...
                            <td style="width: 30%">
                                <label for="chkbox_001"><span class="fa fa-users"></span>&nbsp;&nbsp;&nbsp;&nbsp;Not Done</label>
                                <input id="chkbox_001" type="checkbox" class="form-check-input-styled" data-fouc="">
                            </td>
                            <?php else: ?>
                            <td style="width: 30%">
...
</html><?php /**PATH C:\wamp64\www\IOM\resources\views/pages/Certificate.blade.php ENDPATH**/ ?>