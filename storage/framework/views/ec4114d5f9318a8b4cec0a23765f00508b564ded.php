<?php $__env->startSection('title', 'Phlebotomy Rapid Test Results'); ?>
    ...
    <div class="page-header">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span> Phlebotomy Rapid Test Results</h4>
            ...
            <div class="header-elements d-none py-0 mb-3 mb-md-0">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active"> Phlebotomy Rapid Test Results</span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="col-md-12 text-center">
                            <div class="row justify-content-center">
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-success legitRipple" id="savePlbe">Save
                                    </button>
                                </div>
                                <div class="col-md-1">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src=<?php echo e(asset('jsPages/PhlebotomyRapidTestResults.js')); ?> type="text/javascript"></script>
<?php $__env->stopSection(); ?>


<?php endif; ?>

<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pages/PhlebotomyRapidTestResults.blade.php ENDPATH**/ ?>