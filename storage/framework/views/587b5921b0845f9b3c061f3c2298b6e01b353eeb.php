<?php $__env->startSection('title', 'IOM - PHLEBOTOMY RAPID TEST RESULTS'); ?>
    ...
    <div class="page-header">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span> PHLEBOTOMY RAPID
                    TEST RESULTS</h4>
