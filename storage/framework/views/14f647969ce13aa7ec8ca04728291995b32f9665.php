<?php $__env->startSection('title', ' Cancel And ReSchedule'); ?>
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>Cancel And Reshedule
            </h4>
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Cancel And Reshedule</span>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-3">
                                    <label><span class="fa fa-hand-o-right"></span>&nbsp;&nbsp;Name
                                        In Full:</label>
                                    <div class="form-group">
                                        <input type="text" id="txtNameInFull" class="form-control" readonly="readonly"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="txtAppointmentStatus" class="form-control"
                                            readonly="readonly" style="background: #eee;pointer-events: none;">
                                        <input type="text" id="txtEmail" class="form-control" readonly="readonly" style="display:none;">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card card-body">
                                <div class="row text-center">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <h5 class="font-weight-semibold mb-0"><span id="appointmentCount"></span></h5>
                                        <span class="text-muted font-size-sm"
                                            style="font-size: 20px;">All Appointments</span>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        ...
                                        <span class="text-muted font-size-sm" style="font-size: 20px;">All Members</span>
                                    </div>
                                    <div class="col-3">
                                        <p><i class="fa fa-id-card fa-2x d-inline-block text-info"></i></p>
                                        <h5 class="font-weight-semibold mb-0"><span id="CountryappointmentCount"></span>
                                        </h5>
                                        <?php $segment = request()->segment(count(request()->segments())); ?>
                                        <span class="text-muted font-size-sm" style="font-size: 20px;"><?php echo e($segment); ?>
                                    ...
                                    <div class="col-3">
                                        <p><i class="fa fa-users fa-2x d-inline-block text-warning"></i></p>
                                        <h5 class="font-weight-semibold mb-0"><span id="CountrymembersCount"></span>
                                        </h5>
                                        <span class="text-muted font-size-sm" style="font-size: 20px;"><?php echo e($segment); ?>
...
<script src="<?php echo e(asset('plugins/fullCalender/moment.min.js')); ?>" type="text/javascript"></script>
    ...
    <script src="<?php echo e(asset('jsPagesMhac/CancelAndReshedule.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/cancelandreshedule.blade.php ENDPATH**/ ?>