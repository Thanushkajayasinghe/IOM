<?php $__env->startSection('title', 'Cancel And Reshedule Landing'); ?>
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>Cancel And Reshedule</h4>
...
<script src="<?php echo e(asset('jsPagesMhac/CancelAndResheduleLanding.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/cancelandreshedulelanding.blade.php ENDPATH**/ ?>