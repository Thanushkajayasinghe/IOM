...
<html lang="en">
   <head>
      ...
      <title>IOM | Doctor Display</title>
   ...
   <body style="position: relative;text-align: center;background-color: #D9AFD9;background-image: linear-gradient(0deg, #D9AFD9 0%, #97D9E1 100%);">
                     ...
                     <div class="col-12 row" style="border-bottom: 2px solid #bcb9b9;">
                        <div class="col-md-6">
                           <h1 style="font-size: 3rem;"><span class="badge badge-primary"
                              style="padding: 14px;border-radius: 35px;background: #034981;">DOCTOR ROOM</span>
                           </h1>
                        </div>
                        <div class="col-md-6 text-center">
                           <h1 style="font-size: 3rem;"><span class="badge badge-info"
                              style="padding: 14px;border-radius: 35px;background: #034981;">TOKEN NO</span>
                           </h1>
                        </div>
                     </div>
                  </div>
      ...
      <script src="<?php echo e(asset('jsPagesMhac/DoctorDisplay.js')); ?>?v=<?php echo e($version); ?>" type="text/javascript"></script>
      <script>
...
</html><?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/doctordisplay.blade.php ENDPATH**/ ?>