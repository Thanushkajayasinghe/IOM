...
<?php $__env->startSection('header'); ?>
    <link href=<?php echo e(asset('css/ArrowCssBtnCol3.css')); ?> rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('css/3dbuttons.css')); ?>" rel="stylesheet" type="text/css">


    <script src="<?php echo e(asset('plugins/jSignature/flashcanvas.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('plugins/jSignature/jSignature.min.js')); ?>" type="text/javascript"></script>
            ...
            <div class="content">
                ...
                <div id="congif">
                    <center style="background-color: #e4f0f0">
                        <img src="<?php echo e(asset('images/TabLoading.gif')); ?>" width="40%" height="40%">
...
<?php $__env->startSection('scripts'); ?>
    ...
    var pdfPath = '<?php echo e(url('/plugins/')); ?>';
    </script>
    <script src=<?php echo e(asset('plugins/signature_pad/signature_pad.umd.js')); ?> type="text/javascript"></script>
    <script src=<?php echo e(asset('jsPages/CounselingTAB.js')); ?> type="text/javascript"></script>

<?php $__env->stopSection(); ?>


<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pages/CounselingTAB.blade.php ENDPATH**/ ?>