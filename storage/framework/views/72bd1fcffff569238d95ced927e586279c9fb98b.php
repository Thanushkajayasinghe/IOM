...
<head>
    ...
    <title>IOM | Registration Display</title>
...
<body style="background: linear-gradient(to right, #ededed, #d7e6a5, #b8cb74);">
                    ...
                    <div class="row align-items-center" id="Diplay">
                        <div class="col-12 row ww align-items-center">
                            <div class="col-md-6 eachDiv" attr-group="2">
                                <div class="col" style="font-size: 2.5rem; font-weight: bold;"><span
                                        class="aaa">Registration Counter 1</span>
                                </div>
                            </div>
                        ...
                        <div class="col-12 row ww align-items-center">
                            <div class="col-md-6 eachDiv" attr-group="3">
                                <div class="col" style="font-size: 2.5rem; font-weight: bold;"><span
                                        class="aaa">Registration Counter 2</span>
                                </div>
                            </div>
                            <div class="col-md-6 text-center tokenPlaceHolder">
                                <h2>-</h2>
                        ...
                        <div class="col-12 row ww align-items-center">
                            <div class="col-md-6 eachDiv" attr-group="4">
                                <div class="col" style="font-size: 2.5rem; font-weight: bold;"><span
                                        class="aaa">Registration Counter 3</span>
                                </div>
                            </div>
                            <div class="col-md-6 text-center tokenPlaceHolder">
                                <h2>-</h2>
                        ...
                        <div class="col-12 row ww align-items-center">
                            <div class="col-md-6 eachDiv" attr-group="5">
                                <div class="col" style="font-size: 2.5rem; font-weight: bold;"><span
                                        class="aaa">Registration Counter 4</span>
                                </div>
                            </div>
                            <div class="col-md-6 text-center tokenPlaceHolder">
                                <h2>-</h2>
                        ...
                        <div class="col-12 row ww align-items-center">
                            <div class="col-md-6 eachDiv" attr-group="6">
                                <div class="col" style="font-size: 2.5rem; font-weight: bold;"><span
                                        class="aaa">Registration Counter 5</span>
                                </div>
                            </div>
                            <div class="col-md-6 text-center tokenPlaceHolder">
                                <h2>-</h2>
                        ...
                        <div class="col-12 row ww align-items-center">
                            <div class="col-md-6 eachDiv" attr-group="7">
                                <div class="col" style="font-size: 2.5rem; font-weight: bold;"><span
                                        class="aaa">Registration Counter 6</span>
                                </div>
                            </div>
                            <div class="col-md-6 text-center tokenPlaceHolder">
                                <h2>-</h2>
    ...
    <script src="<?php echo e(asset('jsPagesMhac/RegistrationDisplay.js')); ?>?v=<?php echo e($version); ?>" type="text/javascript"></script>
    <script>     
...
</html><?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/registrationdisplay.blade.php ENDPATH**/ ?>