<?php $__env->startSection('title', 'Make Appointments - AU'); ?>
    ...
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Make Appointments - AU</span>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <input type="text" class="form-control" id="txtFirstName" match="^.+$" validate="true" error="* required">
                                        <div class="text-danger error"></div>
                                    </div>

                                    <div class="col-md-3 form-group">
                                        <label><span class="fa fa-pencil"></span>&nbsp;&nbsp;Last Name</label>
                                        <input type="text" class="form-control" id="txtLastName" match="^.+$" validate="true" error="* required">
                                        <div class="text-danger error"></div>
                                    </div>
                                    ...
                                    <div class="col-md-3 form-group">
                                        <label><span class="fa fa-calendar"></span>&nbsp;&nbsp;Date of
                                            Birth</label>
                                        <input type="text" class="form-control dppicker" readonly id="txtDob" match="^.+$" validate="true" error="* required">
                                        <div class="text-danger error"></div>
                                    </div>
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <input type="text" class="form-control" id="txtMainPassNo" match="^.+$" validate="true" error="* required">
                                        <div class="text-danger error"></div>
                                    </div>
                        ...
                        <div class="form-group text-center calenderDiv">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div id='calenderPanelSel' style="box-shadow: 0 5px 5px -5px rgba(0, 0, 0, 0.1);border: 1px solid #f3dfdf;"></div>
                                            <div class="col-md-12 row" style="margin-top: 20px;">
                                                ...
                                                ?> -->
                                                <strong>Total Appointmets For Australia:&nbsp;<lable id="totalAppointmentCount"></lable></strong>
                                            </div>
                                            <div class="col-md-12 row" style="margin-top: 10px;">
                                                <strong>Total Appointmets:&nbsp;<lable id="totalAppointmentCount"></lable></strong>
                                            </div>
                                        </div>
...
<script src="<?php echo e(asset('jsPagesMhac/MakeAppointmentAu.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/makeappointmentsau.blade.php ENDPATH**/ ?>