<?php $__env->startSection('title', 'Payment Counter - Re Print'); ?>
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>Payment Counter - Re Print </h4>
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Payment Counter - Re Print</span>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="card-header">
                    ...
                    <div class="col-md-12 text-center">
                        <div class="row justify-content-center">
                            <div class="col-md-2">
                                <button type="button" class="btn-block btn-success btn-lg btn3d" id="btnReprint">
                                    <span class="fa fa-print"></span>&nbsp;Reprint
                                </button>
                            </div>
                            <div class="col-md-2">
...
<script src=<?php echo e(asset('jsPages/ApplicantOnSitePaymentReprint.js')); ?> type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pages/ApplicantOnSitePaymentReprint.blade.php ENDPATH**/ ?>