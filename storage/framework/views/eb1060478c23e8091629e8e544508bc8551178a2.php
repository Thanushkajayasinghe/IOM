<?php $__env->startSection('title', 'Set Work Schedule'); ?>

<?php if($readWrite =='true'): ?>

<?php $__env->startSection('header'); ?>
<link href="<?php echo e(asset('css/setWorkSchedule.css')); ?>" rel="stylesheet" type="text/css" />
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="HolidayCalender">
                            <div class="row justify-content-center align-items-center form-group" style="margin-top: 60px;">
                                ...
                                <p>
                                    <button type="button" id="disableSat" class="btn bg-teal-400 btn-labeled btn-labeled-left rounded-round legitRipple" style="margin-left: 20px;margin-top: 5px;"><b><img src="<?php echo e(asset('images/saturday.png')); ?>" style="width: 20px;position: relative;top: -2px;"></b> Saturday
                                    </button>
                                    <button type="button" id="disableSun" class="btn bg-teal-400 btn-labeled btn-labeled-left rounded-round legitRipple" style="margin-left: 20px;margin-top: 5px;"><b><img src="<?php echo e(asset('images/sunday.png')); ?>" style="width: 20px;position: relative;top: -2px;"></b> Sunday
                                    </button>
                                </p>
                            </div>
...
<script src="<?php echo e(asset('js/twix.min.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('jsPages/SystemConfigurations.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>

<?php endif; ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pages/SetWorkSchedule.blade.php ENDPATH**/ ?>