<?php $__env->startSection('title', 'Vitals Landing'); ?>
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>Vitals</h4>
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Check Vitals</span>
            </div>
        </div>
    </div>
</div>
...
<script src="<?php echo e(asset('jsPagesMhac/VitalsLanding.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/vitalslanding.blade.php ENDPATH**/ ?>