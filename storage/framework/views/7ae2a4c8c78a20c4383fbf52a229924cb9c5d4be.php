                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="labno" match="^.+$"
                                                   validate="true" error="* Lab No required"><br>
                                        </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('jsPages/TBTestResulr.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pages/TBTestResult.blade.php ENDPATH**/ ?>