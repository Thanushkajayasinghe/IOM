    ...
    <div class="page-header">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>IOM - TB
                </h4>
            ...
            <div class="header-elements d-none py-0 mb-3 mb-md-0">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">TB</span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 form-group">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" readonly id="txtPassportNo" style="pointer-events: none; background-color: #eee;">
                                </div>
                                <div class="col-md-3 ">
                        ...
                        <div class="col-md-12 form-group">
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <label style="visibility: hidden;"><span class="fa fa-hand-o-right"></span>&nbsp;&nbsp;Teuy: </label>
                                    <button id="btnAddToGrid" class="btn btn-primary btn-sm" type="button"><span class="fa fa-plus"></span></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 form-group">
                            <div class="text-center">
                                <button type="button" id="btnSave" class="btn btn-success"><span class="fa fa-floppy-o"></span>&nbsp;Save</button>
                            </div>
                        </div>
...
<?php $__env->startSection('scripts'); ?>
    <script src=<?php echo e(asset('jsPages/TBInter.js')); ?> type="text/javascript"></script>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pages/TBInter.blade.php ENDPATH**/ ?>