...
<table width="100%">
    <tr>
        <td width="50%">[Date] : <?php echo e(date("Y-m-d")); ?></td>
        <td width="50%"></td>
    </tr>
...
<table border="1" width="100%" style="margin-top: 20px;">
    ...
    <tr>
        <td width="60%" style="vertical-align: top; height: 6%;"><?php echo e($radiologistReporting[0]->rr_comment2); ?></td>
    </tr>
</table>
...
<?php /**PATH C:\wamp64\www\IOM\resources\views/Reports/SystemReferralFormSpecialist.blade.php ENDPATH**/ ?>