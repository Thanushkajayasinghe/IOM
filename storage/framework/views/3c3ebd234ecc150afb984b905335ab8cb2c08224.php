<?php $__env->startSection('title', 'IHU Report'); ?>

<?php $__env->startSection('header'); ?>

    <link href="<?php echo e(asset('js/DataTables/css/select.bootstrap.css')); ?>" rel="stylesheet" type="text/css"/>
    <style>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <!--JS files-->
    <script src="<?php echo e(asset('plugins/DataTable/js/buttons.colVis.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('plugins/DataTable/js/dataTables.select.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('jsPages/ihuReport.js')); ?>" type="text/javascript"></script>
    <script>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pages/IHUReport.blade.php ENDPATH**/ ?>