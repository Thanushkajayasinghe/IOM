<?php $__env->startSection('title', 'Make Appointments - CA'); ?>
    ...
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="header-elements d-none py-0 mb-3 mb-md-0">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Make Appointments - CA</span>
            </div>
        </div>
    </div>
</div>
...
<script src="<?php echo e(asset('jsPagesMhac/MakeAppointmentCa.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/makeappointmentsca.blade.php ENDPATH**/ ?>