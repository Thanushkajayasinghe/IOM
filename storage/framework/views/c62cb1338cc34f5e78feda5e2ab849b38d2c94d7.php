<?php $__env->startSection('title', 'TB Report'); ?>
        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none py-0 mb-3 mb-md-0">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">TB Report</span>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="table-responsive" style="max-height: 500px; overflow: auto;">
                                    <table class="table table-bordered table-hover table-striped text-center dataTable"
                                        ...
                                        <tr>
                                            ...
                                            <th nowrap>X-ray Result</th>
                                            <th nowrap>Gene Xpert</th>
                                            <th nowrap>Sputum Collected</th>
                                        </tr>
                                        </thead>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <!--JS files-->
    <script src="<?php echo e(asset('jsPages/TBReport.js')); ?>" type="text/javascript"></script>
    <script>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pages/TBReport.blade.php ENDPATH**/ ?>