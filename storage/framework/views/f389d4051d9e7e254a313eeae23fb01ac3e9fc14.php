...
<table style="width: 100%;">
    <thead>
      <tr style="width: 100%;">
          ...
          <td style="width: 45%;" colspan="3"> <label id="name"><?php echo e($ApplicantDetails->FirstName); ?> <?php echo e($ApplicantDetails->LastName); ?></label></td>
...
<div class="col-md-12">
    <div class="row" style="margin-top: 30px;">
      ...
      lung fields
        ...
        <div class="col-md-4" style="margin-top: 10px;">
            Comment01:<lable><?php echo e($ApplicantDetails->rr_comment1); ?></lable>
        </div>
        
        <div class="col-md-4" style="margin-top: 10px;">
            Comment02:<lable><?php echo e($ApplicantDetails->rr_comment2); ?></lable>
        </div>
