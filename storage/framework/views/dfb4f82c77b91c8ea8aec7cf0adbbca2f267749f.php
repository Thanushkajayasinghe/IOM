...
<html lang="en">
    <head>
        ...
        <title>IOM | Phlebotomy Display</title>
    ...
    <body style="position: relative;text-align: center;background: linear-gradient(to right, #e9a55c, #ffd9a0, #ffceab);">
    ...
    <div class="content" style="position: absolute;top: -5px;right: 0;bottom: 0;width: 100%;">
                        ...
                        <div class="col-12 row" style="border-bottom: 2px solid #bcb9b9;">
                            <div class="col-md-6">
                                <h1 style="font-size: 3rem;"><span class="badge badge-primary"
                                        style="padding: 14px; border-radius: 35px;">PHLEBOTOMY CENTER</span>
                                </h1>
                            </div>
                    ...
                    <div class="row align-items-center" id="Diplay">
                        <div class="col-12 row ww align-items-center">
                            <div class="col-md-6 eachDiv" attr-group="2">
                                <div class="col" style="font-size: 2.5rem; font-weight: bold;"><span
                                        class="aaa">Phlebotomy Counter 1</span>
                                </div>
                            </div>
                        ...
                        <div class="col-12 row ww align-items-center">
                            <div class="col-md-6 eachDiv" attr-group="3">
                                <div class="col" style="font-size: 2.5rem; font-weight: bold;"><span
                                        class="aaa">Phlebotomy Counter 2</span>
                                </div>
                            </div>
                            <div class="col-md-6 text-center tokenPlaceHolder">
                                <h2>-</h2>
        ...
        <script src="<?php echo e(asset('jsPagesMhac/PhlebotomyDisplay.js')); ?>?v=<?php echo e($version); ?>" type="text/javascript"></script>
        <script>
...
<?php /**PATH C:\wamp64\www\IOM\resources\views/pagesmhac/phlebotomydisplay.blade.php ENDPATH**/ ?>