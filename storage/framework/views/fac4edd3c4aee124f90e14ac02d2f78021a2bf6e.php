<?php $__env->startSection('title', 'Malaria Report'); ?>
        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none py-0 mb-3 mb-md-0">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Malaria Report</span>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <!--JS files-->
    <script src="<?php echo e(asset('jsPages/MalariaReport.js')); ?>" type="text/javascript"></script>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\IOM\resources\views/pages/MalariaReport.blade.php ENDPATH**/ ?>