...
const lastTwoLetters = lastPart.slice(-2);
    ...
    $("#next").on("click", function () {
        ...
        str = "Yes";
        $.ajax({
            url: "/IOM/DoctorLoadData", // URL to your backend endpoint
            type: "post",
            dataType: "json",
            headers: {
                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
                            ...
                            if (val.hiv == true) {
                                ...
                                $(data.result2).each(function (key, val2) {
                                    if (val2.hiv_result == "Positive") {
                                        ...
                                        html += "<td style='display: none;'>" + val2.id + "</td>";
                                        html += "<td>" + co + "</td>";
                                        html += "<td>HIV</td>";
                                        html += "<td>" + val2.hiv_result + "</td>";
                                        html += "<td><input class=\"form-control\" type=\"text\" id='txtComment" + key + "' value='" + val2.hiv_remark + "'></td>";
                                        html += "</tr>";
                                        html += "<tr>";
                                    } else {
                                        html += "<tr>";
                            ...
                            if (val.filaria == true) {
                                ...
                                $(data.result2).each(function (key, val2) {
                                    if (val2.filaria_result == "Positive") {
                                        ...
                                        html += "<td>" + co + "</td>";
                                        html += "<td>Filaria</td>";
                                        html += "<td>" + val2.filaria_result + "</td>";
                                        html += "<td><input class=\"form-control\" type=\"text\" id='txtComment" + key + "' value='" + val2.filaria_remark + "'></td>";
                                        html += "</tr>";
                                        html += "<tr>";
                                    } else {
                                        html += "<tr>";
                            ...
                            if (val.malaria == true) {
                                ...
                                $(data.result2).each(function (key, val2) {
                                    if (val2.malaria_result == "Positive") {
                                        ...
                                        html += "<td>" + co + "</td>";
                                        html += "<td>Malaria</td>";
                                        html += "<td>" + val2.malaria_result + "</td>";
                                        html += "<td><input class=\"form-control\" type=\"text\" id='txtComment" + key + "' value='" + val2.malaria_remark + "'></td>";
                                        html += "</tr>";
                                        html += "<tr>";
                                    } else {
                                        html += "<tr>";
                            ...
                            if (val.shcg == true) {
                                ...
                                $(data.result2).each(function (key, val2) {
                                    if (val2.shcg_result == "Positive") {
                                        ...
                                        html += "<td>" + co + "</td>";
                                        html += "<td>SHCG</td>";
                                        html += "<td>" + val2.shcg_result + "</td>";
                                        html += "<td><input class=\"form-control\" type=\"text\" id='txtComment" + key + "' value='" + val2.shcg_remark + "'></td>";
                                        html += "</tr>";
                                        html += "<tr>";
                                    } else {
                                        html += "<tr>";
                                ...
                                $(data.result2).each(function (key, val2) {
                                    if (val2.urine_result == "Positive") {
                                        ...
                                        html += "<td>" + co + "</td>";
                                        html += "<td>Urine</td>";
                                        html += "<td>" + val2.urine_result + "</td>";
                                        html += "<td><input class=\"form-control\" type=\"text\" id='txtComment" + key + "' value='" + val2.urine_remark + "'></td>";
                                        html += "</tr>";
                                        html += "<tr>";
                                    } else {
                                        html += "<tr>";
