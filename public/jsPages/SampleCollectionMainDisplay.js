$(document).ready(function () {
    ...
    function LoadData() {
        $.ajax({
            ...
            data: {command: 'sampleCol'},
            success: function (data) {
                $("#Diplay").html('');
                $.each(data, function (key, val) {

                    var center = 'Phlebotomy Counter ' + (key + 1) + '';
                ...
                success: function (data) {
                    ...
                    $(data.result).each(function (key, val) {
                        ...
                        if (tokenUpdate != val.temp_token_no) {
                            ...
                            $this.next().html('');
                            $this.next().html('<h2 style="font-size: 4.2em; font-weight: bold;">' + val['temp_token_no'] + '</h2>');
                        }
                    });
                }, complete: function () {
